...
const styles = StyleSheet.create({
  ...
  container: {
    ...
    // button (no marginBottom) follows the last password field, not enough
    // runway on its own for the ScrollView to bring that field above the
    // keyboard (FP-203-mobile-adj-1).
    paddingBottom: 300,
    backgroundColor: "#fff",
    flexGrow: 1,
  },
